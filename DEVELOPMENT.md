...
```bash
git remote add encore encore://school-run-bus-app-3iki
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/school-run-bus-app-3iki/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/school-run-bus-app-3iki/settings/integrations/github)
